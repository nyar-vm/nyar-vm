...
impl NyarVM {
    ...
    #[inline(always)]
    pub fn execute_i32_add(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_sub(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_mul(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_div_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_div_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_rem_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_rem_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_eq(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_ne(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as i32) != (rhs.as_int() as i32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_lt_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as i32) < (rhs.as_int() as i32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_lt_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
    ...
    #[inline(always)]
    pub fn execute_i32_le_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as i32) <= (rhs.as_int() as i32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_le_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as u32) <= (rhs.as_int() as u32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_gt_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as i32) > (rhs.as_int() as i32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_gt_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as u32) > (rhs.as_int() as u32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_ge_s(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as i32) >= (rhs.as_int() as i32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_ge_u(&mut self) -> Result<Option<usize>, VmError> {
        let rhs = self.pop()?;
        let lhs = self.pop()?;
        let r = (lhs.as_int() as u32) >= (rhs.as_int() as u32);
        self.push(Value::bool(r))?;
    ...
    #[inline(always)]
    pub fn execute_i32_trunc64_s_low(&mut self) -> Result<Option<usize>, VmError> {
        let v = self.pop()?;
