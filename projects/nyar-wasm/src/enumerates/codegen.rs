...
impl<'a, 'i> IntoWasm<'a, wast::component::Type<'i>> for EnumerateType
where
    'a: 'i,
{
...
impl<'a, 'i> IntoWasm<'a, wast::core::Type<'i>> for EnumerateType
where
    'a: 'i,
{
...
impl<'a, 'i> IntoWasm<'a, wast::component::TypeDef<'i>> for EnumerateType
where
    'a: 'i,
{
...
impl<'a, 'i> IntoWasm<'a, wast::core::TypeDef<'i>> for EnumerateType
where
    'a: 'i,
{
