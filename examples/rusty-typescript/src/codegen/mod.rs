...
impl GaiaTranslator {
        ...
        if !functions.iter().any(|f| f.name == "main") {
            let main_function = GaiaFunction {
                ...
                blocks: vec![GaiaBlock {
                    ...
                    instructions: vec![GaiaInstruction::Core(CoreInstruction::PushConstant(
                        GaiaConstant::I32(0),
                    ))],
    ...
    fn convert_type(&self, c_type: &Type) -> GaiaType {
        match c_type {
            ...
            Type::Pointer(inner) => GaiaType::Pointer(
                Box::new(self.convert_type(inner)),
                gaia_assembler::types::AddressSpace::Generic,
            ),
    ...
    fn generate_expression(
        ...
        match expression {
            ...
            Expression::Conditional {
                ...
                self.generate_conditional_expression(
                    condition,
                    true_expr,
                    false_expr,
                    instructions,
            ...
            _ => {
                ...
                let op_instruction = match operator {
                    AssignmentOperator::AddAssign => {
                        GaiaInstruction::Core(CoreInstruction::Add(ty))
                    }
                    AssignmentOperator::SubAssign => {
                        GaiaInstruction::Core(CoreInstruction::Sub(ty))
                    }
                    AssignmentOperator::MulAssign => {
                        GaiaInstruction::Core(CoreInstruction::Mul(ty))
                    }
                    AssignmentOperator::DivAssign => {
                        GaiaInstruction::Core(CoreInstruction::Div(ty))
                    }
                    AssignmentOperator::ModAssign => {
                        GaiaInstruction::Core(CoreInstruction::Rem(ty))
                    }
                    AssignmentOperator::AndAssign => {
                        GaiaInstruction::Core(CoreInstruction::And(ty))
                    }
                    AssignmentOperator::OrAssign => GaiaInstruction::Core(CoreInstruction::Or(ty)),
                    AssignmentOperator::XorAssign => {
                        GaiaInstruction::Core(CoreInstruction::Xor(ty))
                    }
                    AssignmentOperator::LeftShiftAssign => {
                        GaiaInstruction::Core(CoreInstruction::Shl(ty))
                    }
                    AssignmentOperator::RightShiftAssign => {
                        GaiaInstruction::Core(CoreInstruction::Shr(ty))
                    }
                    _ => unreachable!(),
                };
